...
<head>
    ...
    <title>Crear Asignación Diaria</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        ...
        <div class="header">
            ...
            <div class="header-right">
                <form id="mainForm" method="POST" action="{{ route('asignacion-diaria.guardar') }}" style="display: flex; gap: 1.5rem; flex: 1; max-width: 800px;">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="fecha" id="fechaInput" value="{{ now()->format('Y-m-d') }}" required>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="content">
            ...
            <div class="left-panel">
                ...
                <div class="observations">
                    <h3>Observaciones</h3>
                    <textarea id="observacionesInput" name="observaciones" placeholder="Escribe aquí alguna observación..." rows="2"></textarea>
                </div>
            </div>
    ...
    <script>
        ...
        state.productos.forEach(p => {
            state.productosMap = state.productosMap || {};
        ...
        document.getElementById('vendedorSelect').addEventListener('change', function() {
            // Auto-fill sucursal based on vendedor
            const vendedorId = this.value;
            if (vendedorId) {
                // You can add AJAX call here to get vendedor's sucursal
            }
        });
