...
<body>
        ...
        <div class="header">
            ...
            <div class="header-right">
                <div class="form-group">
                    ...
                    <select id="vendedorSelect" required>
                        ...
                        @foreach($vendedores as $v)
                            <option value="{{ $v->id }}" {{ $v->tiene_asignacion_hoy ? 'disabled' : '' }}>
                                {{ $v->nombre }} {{ $v->apellido }}
                ...
                <div class="form-group">
                    ...
                    <input type="date" id="fechaInput" value="{{ now()->format('Y-m-d') }}" required>
                </div>
            </div>
        </div>
        ...
        <div class="content">
            ...
            <div class="left-panel">
                ...
                <div class="observations">
                    <h3>Observaciones</h3>
                    <textarea id="observacionesInput" placeholder="Escribe aquí alguna observación..." rows="2"></textarea>
                </div>
            </div>
    ...
    <script>
        ...
        // los primeros 12 productos que ya venían cargados en la página, así
        // que cualquier producto fuera de esos 12 (por orden alfabético) era
        // invisible sin importar lo que se escribiera acá. Ahora sí consulta
        // todo el catálogo.
