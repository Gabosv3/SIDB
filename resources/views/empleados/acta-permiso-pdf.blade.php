...
<div class="page">
    ...
    <div class="titulo">ACTA DE PERMISO</div>
    ...
    <table class="fila">
        <tr>
            ...
            <td style="width:40%;">
                <div class="campo">
                    <div class="label">Fecha del permiso</div>
    ...
    <div class="campo">
        <div class="label">Motivo / Detalle del permiso</div>
    ...
    <div class="legal">
        La presente acta se levanta como constancia de la autorización otorgada al/a la trabajador(a) para ausentarse
        en la fecha indicada, quedando registrada en su expediente laboral. Esta ausencia se considera justificada
        para todos los efectos, y no constituye falta de asistencia conforme al Código de Trabajo.
    </div>
